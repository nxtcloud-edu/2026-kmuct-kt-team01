...
export const LayersIcon = (props: IconProps) => <svg {...base} {...props}><path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5"/></svg>
export const CloseIcon = (props: IconProps) => <svg {...base} {...props}><path d="M6 6l12 12M18 6 6 18"/></svg>
